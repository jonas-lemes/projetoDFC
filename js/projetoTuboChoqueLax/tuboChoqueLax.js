function calculoTuboChoqueLax() {
    ...
    for (t = 0; t <= 299; t++) {
        for (x = 1; x <= 999; x++) {
            q[x][0] = q[x][0] + ((q[x+1][0] - 2 * q[x][0] + q[x-1][0])/2) - (lambda/2) * (e[x+1][0] - e[x-1][0]);
            q[x][1] = q[x][0] + ((q[x+1][1] - 2 * q[x][1] + q[x-1][1])/2) - (lambda/2) * (e[x+1][1] - e[x-1][1]);
            q[x][2] = q[x][0] + ((q[x+1][2] - 2 * q[x][2] + q[x-1][2])/2) - (lambda/2) * (e[x+1][2] - e[x-1][2]);
        }
